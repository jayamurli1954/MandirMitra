...
def create_default_chart_of_accounts(db: Session, temple_id: int):
    ...
    accounts = [
        ...
        },
        {
            ...
            "is_system_account": True,
            "allow_manual_entry": False,
            "description": "Income from in-kind sponsorships (direct vendor payment - no cash movement)"
        },
        ...
        # In-Kind Expense Accounts (for direct payment sponsorships - no cash movement)
        {
            "account_code": "5404",
            ...
            "is_system_account": True,
            "allow_manual_entry": False,
            "description": "Flower decoration expense for in-kind sponsorships (devotee paid vendor directly)"
        },
        {
            "account_code": "5405",
            ...
            "is_system_account": True,
            "allow_manual_entry": False,
            "description": "Lighting expense for in-kind sponsorships (devotee paid vendor directly)"
        },
        {
            "account_code": "5406",
            ...
            "is_system_account": True,
            "allow_manual_entry": False,
            "description": "Tent expense for in-kind sponsorships (devotee paid vendor directly)"
        },
        {
            "account_code": "5407",
            ...
            "is_system_account": True,
            "allow_manual_entry": False,
            "description": "Sound system expense for in-kind sponsorships (devotee paid vendor directly)"
        },
