...
def update_temple_location(
    temple_id: int, city_name: str = None, latitude: str = None, longitude: str = None
):
    """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 3:
        ...
        update_temple_location(
            temple_id, city_name=city_name, latitude=latitude, longitude=longitude
        )
    else:
        print("❌ Invalid arguments")
        print("Usage: python update_temple_location.py <temple_id> <city_name>")
        print(
            "   OR: python update_temple_location.py <temple_id> <latitude> <longitude> <city_name>"
        )
