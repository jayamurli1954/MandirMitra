# MandirSync - Environment Configuration Guide
...
conda create -n mandirsync python=3.11
conda activate mandirsync
...
```env
# ============================================
# MandirSync Backend Configuration
# ============================================
