...
class TestHundiManagement:
    ...
    def test_list_hundis(self, authenticated_client):
        ...
        response = authenticated_client.get("/api/v1/hundi/hundis")
    ...
    def test_get_hundi_by_id(self, authenticated_client):
        ...
        # Create hundi
        hundi_data = {
            "hundi_code": "HUNDI-GET",
            "hundi_name": "Test Hundi",
            "is_active": True
        }
...
class TestHundiCollections:
    ...
    def test_list_hundi_collections(self, authenticated_client):
        """Test listing all hundi collections"""
        response = authenticated_client.get("/api/v1/hundi/collections")
