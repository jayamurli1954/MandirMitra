...
class TestUserIntegration:
    ...
    def test_create_user(self, db_session):
        ...
        user = UserFactory(email="test@example.com", full_name="Test User", role="accountant")
...
class TestDonationIntegration:
    ...
    def test_create_donation(self, db_session):
        ...
        from tests.factories import DonationCategoryFactory

        TempleFactory._meta.sqlalchemy_session = db_session
        DevoteeFactory._meta.sqlalchemy_session = db_session
        DonationCategoryFactory._meta.sqlalchemy_session = db_session
    ...
    def test_devotee_with_multiple_donations(self, db_session):
        ...
        DonationCategoryFactory._meta.sqlalchemy_session = db_session
        devotee, donations = create_test_devotee_with_donations(db_session, num_donations=5)
    ...
    def test_query_donations_by_temple(self, db_session):
        ...
        temple1_donations = db_session.query(Donation).filter_by(temple_id=temple1.id).all()
