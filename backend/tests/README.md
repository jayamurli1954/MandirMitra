# MandirSync Testing Guide

This directory contains automated tests for the MandirSync backend API.
...
View results at: `https://github.com/YOUR-USERNAME/MandirSync/actions`
