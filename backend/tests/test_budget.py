...
class TestBudgetManagement:
    ...
    def test_create_annual_budget(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/budget/budgets", json=budget_data)
    ...
    def test_list_budgets(self, authenticated_client):
        ...
        response = authenticated_client.get("/api/v1/budget/")
    ...
    def test_create_department_budget(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/budget/allocations", json=allocation_data)
    ...
    def test_get_budget_vs_actual(self, authenticated_client):
        ...
        response = authenticated_client.get(
            "/api/v1/budget/reports/budget-vs-actual", params={"budget_id": 1}
        )
...
class TestFCRABudget:
    ...
    def test_create_fcra_budget(self, authenticated_client):
        ...
        response = authenticated_client.post("/api/v1/budget/budgets", json=fcra_budget)
