...
def upgrade() -> None:
    ...
    add_column_if_not_exists('temples', sa.Column('pan_number', sa.String(length=20), nullable=True))
    add_column_if_not_exists('temples', sa.Column('tan_number', sa.String(length=20), nullable=True))
