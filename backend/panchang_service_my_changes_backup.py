...
class PanchangService:
    ...
    def detect_special_days(self, tithi_data: Dict, vara_data: Dict, nakshatra_data: Dict) -> List[Dict]:
    ...
    def get_nakshatra_quality(self, nakshatra_name: str) -> Dict:
        ...
        auspicious = ["Ashwini", "Krittika", "Mrigashira", "Punarvasu", "Uttara Phalguni", 
                     "Chitra", "Vishakha", "Uttara Ashadha", "Uttara Bhadrapada"]
        moderate = ["Bharani", "Magha", "Purva Phalguni", "Jyeshtha", "Purva Ashadha", 
                   "Dhanishta", "Shatabhisha", "Purva Bhadrapada"]
