...
class PanchangDisplaySettingsBase(BaseModel):
    ...
    latitude: str = Field(
        default="12.9716", description="Temple latitude for accurate calculations"
    )
    longitude: str = Field(
        default="77.5946", description="Temple longitude for accurate calculations"
    )
    ...
    secondary_language: Optional[str] = Field(
        default="hi", pattern="^(en|hi|sa|ta|te|kn|mr|bn|gu)$"
    )
