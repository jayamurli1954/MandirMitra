...
from app.models.hr import (
    EmployeeStatus, EmployeeType, SalaryComponentType, PayrollStatus
)
...
class EmployeeBase(BaseModel):
    employee_code: Optional[str] = Field(None, max_length=50)  # Optional - will be auto-generated if not provided
