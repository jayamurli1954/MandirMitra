...
from app.services.donation_accounting_service import (
    get_payment_accounts_for_temple as _svc_get_payment_accounts_for_temple,
    post_donation_to_accounting as _svc_post_donation_to_accounting,
)
from app.services.donation_receipt_service import (
    generate_receipt_pdf as _svc_generate_receipt_pdf,
    number_to_words as _svc_number_to_words,
)
from app.services.donation_report_service import (
    build_daily_report as _svc_build_daily_report,
    build_monthly_report as _svc_build_monthly_report,
    build_category_wise_report as _svc_build_category_wise_report,
    build_detailed_donation_report as _svc_build_detailed_donation_report,
)
...
def post_donation_to_accounting(db: Session, donation: Donation, temple_id: int):
    return _svc_post_donation_to_accounting(db, donation, temple_id)
...
def _generate_receipt_pdf(donation: Donation, db: Session):
    return _svc_generate_receipt_pdf(donation, db)


def _number_to_words(n):
    return _svc_number_to_words(n)
...
def get_daily_report(
    ...
    return _svc_build_daily_report(db, date)
...
def get_monthly_report(
    ...
    return _svc_build_monthly_report(db, month, year, current_user.temple_id)
...
def get_category_wise_report(
    ...
    """
    return _svc_build_category_wise_report(db, date_from, date_to, current_user.temple_id)
...
def get_detailed_donation_report(
    ...
    - Amount
    """
    return _svc_build_detailed_donation_report(
        db,
