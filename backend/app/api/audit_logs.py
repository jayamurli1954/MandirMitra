...
def get_audit_summary(
    ...
    """
    if current_user.role != "admin" and not current_user.is_superuser:
        raise HTTPException(status_code=403, detail="Only admins can view audit summary")
    ...
    user_counts = db.query(
        AuditLog.user_name, AuditLog.user_email, func.count(AuditLog.id).label("count")
    )
