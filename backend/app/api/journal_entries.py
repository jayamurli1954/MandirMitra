...
from app.services.journal_entry_helper_service import (
    generate_entry_number as _svc_generate_entry_number,
    validate_journal_entry as _svc_validate_journal_entry,
)
...
def generate_entry_number(db: Session, temple_id: Optional[int]) -> str:
    return _svc_generate_entry_number(db, temple_id)
