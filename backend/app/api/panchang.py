...
def get_today_panchang(
    ...
    try:
        ...
        logger.info("Panchang calculation completed successfully")

        # Return calculated panchang data
        return panchang_data

    except Exception as e:
        error_msg = f"Error calculating panchang: {str(e)}"
...
def generate_kundli(
    ...
    try:
        ...
        return {"success": True, "kundli": kundli_data, "message": "Kundli generated successfully"}
    except Exception as e:
