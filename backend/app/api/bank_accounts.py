...
class BankAccountResponse(BankAccountBase):
    ...
    def from_orm(cls, obj):
        ...
        data = {
            ...
            "created_at": obj.created_at.isoformat() if obj.created_at and isinstance(obj.created_at, datetime) else (str(obj.created_at) if obj.created_at else None),
            "updated_at": obj.updated_at.isoformat() if obj.updated_at and isinstance(obj.updated_at, datetime) else (str(obj.updated_at) if obj.updated_at else None),
        }
        return cls(**data)
...
def create_bank_account(
    ...
    chart_account = db.query(Account).filter(
        Account.temple_id == temple_id,
        Account.account_code == "1110",  # Default bank account code
