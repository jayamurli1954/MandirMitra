...
class InKindConsumption(Base):
    ...
    inkind_donation_id = Column(Integer, ForeignKey('inkind_donations.id'), nullable=False, index=True)
...
class Sponsorship(Base):
    ...
    # Sponsorship Details
    sponsorship_category = Column(String(100), nullable=False, index=True)  # flower_decoration, tent, lighting, etc.
    ...
    # Accounting Integration
    journal_entry_id_commitment = Column(Integer, ForeignKey('journal_entries.id'), nullable=True)  # When committed
    journal_entry_id_payment = Column(Integer, ForeignKey('journal_entries.id'), nullable=True)  # When paid
    journal_entry_id_expense = Column(Integer, ForeignKey('journal_entries.id'), nullable=True)  # When vendor paid/direct payment
