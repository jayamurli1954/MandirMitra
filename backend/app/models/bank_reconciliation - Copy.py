...
class BankStatement(Base):
    ...
    entries = relationship("BankStatementEntry", back_populates="statement", cascade="all, delete-orphan")
...
class ReconciliationOutstandingItem(Base):
    ...
    # Item details
    item_type = Column(String(50), nullable=False)  # "cheque_issued", "deposit_in_transit", "bank_charge", etc.
    ...
    cleared_in_reconciliation_id = Column(Integer, ForeignKey("bank_reconciliations.id"), nullable=True)
    ...
    reconciliation = relationship(
        ...
        back_populates="outstanding_items"
    )
