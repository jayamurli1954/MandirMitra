...
from sqlalchemy import Column, Integer, String, Float, Boolean, Text, Date, DateTime, ForeignKey, Enum as SQLEnum, JSON
...
class HundiOpening(Base):
    ...
    denomination_counts = relationship("HundiDenominationCount", back_populates="hundi_opening", cascade="all, delete-orphan")
...
class HundiDenominationCount(Base):
    ...
    denomination_value = Column(Float, nullable=False)  # 2000, 500, 100, 50, 20, 10, 5, 2, 1, 0.5, 0.25
