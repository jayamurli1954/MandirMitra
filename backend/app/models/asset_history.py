...
class AssetValuationHistory(Base):
    ...
    )  # PURCHASE, REVALUATION, MARKET_VALUE, INSURANCE, DISPOSAL
    valuation_amount = Column(Float, nullable=False)

    # Valuation Method
    valuation_method = Column(
        String(50)
    )  # MARKET_VALUE, PROFESSIONAL_VALUER, INDEX_BASED, COST_BASED
...
class AssetDocument(Base):
    ...
    document_type = Column(
        String(50), nullable=False
    )  # IMAGE, INVOICE, WARRANTY, MANUAL, CERTIFICATE, OTHER
