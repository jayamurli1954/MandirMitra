...
class UpiPayment(Base):
    ...
    bank_transaction = relationship(
        "BankTransaction", foreign_keys="[UpiPayment.bank_transaction_id]"
    )
...
class BankTransaction(Base):
    ...
    )  # Can link to bank_reconciliations table if needed
    ...
    matched_upi_payment = relationship(
        "UpiPayment", foreign_keys="[BankTransaction.matched_upi_payment_id]"
    )
