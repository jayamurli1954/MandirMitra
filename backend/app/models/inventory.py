...
class StockBalance(Base):
    ...
    def __repr__(self):
        return (
            f"<StockBalance(item_id={self.item_id}, store_id={self.store_id}, qty={self.quantity})>"
        )
...
class StockMovement(Base):
    ...
    movement_number = Column(
        String(50), unique=True, nullable=False, index=True
    )  # PUR/2025/001, ISS/2025/001, etc.
