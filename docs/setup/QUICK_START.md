...
**Use this file to quickly get context about the project when starting a new conversation.**
...
- `UI_DECISIONS.md` - UI design decisions
...
**Tell the AI:**
```
"Please read CONVERSATION_LOG.md and UI_DECISIONS.md to understand the project context, then help me [your task]"
```
...
- Dashboard has donation form + panchang widget

---

**For detailed context, see:** `CONVERSATION_LOG.md`
