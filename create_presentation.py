...
def create_presentation():
    ...
    # --- SLIDE 2: Overview ---
    add_content_slide(prs, "What is MandirSync?", [
    ...
    ], "Bottom line: MandirSync converts all of this into a single, reliable system.")

    # --- SLIDE 4: Modules (Using Bullets for simplicity in code) ---
    add_content_slide(prs, "MandirSync – Major Modules", [
    ...
    add_content_slide(prs, "Final Word & Next Steps", [
        "MandirSync combines tradition + technology.",
    ...
    ], "Contact: contact@mandirsync.com | Dhanyavaad")

    # Save
    prs.save('MandirSync_Presentation.pptx')
    print("Presentation created successfully: MandirSync_Presentation.pptx")
