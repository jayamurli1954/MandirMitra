...
```
INFO:     Will watch for changes in these directories: ['D:\\MandirMitra\\backend']
INFO:     Uvicorn running on http://127.0.0.1:8000 (Press CTRL+C to quit)
INFO:     Started reloader process [2400] using WatchFiles
INFO:     Started server process [27344]
INFO:     Waiting for application startup.
✅ Default admin user created: admin@temple.com / admin123
   OR
...
- ❌ Password hashes (excluded from audit logs)
...
- ✅ HTTP request logs (Uvicorn)
- ✅ Error traces
- ✅ Application print statements
- ⚠️ **Not persistent** - Lost when server restarts
...
- ✅ **Queryable** - Can search and filter
